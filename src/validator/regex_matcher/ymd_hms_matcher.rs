pub(crate) fn ymd_hms_matcher(text: &str) -> bool {
...
mod tests {
    ...
    /// expected: `false`
    #[test]
    fn test_ymd_hms_matcher_invalid_format() {
    ...
    /// expected: `false`
    #[test]
    fn test_ymd_hms_matcher_empty_string() {
        let time_str = "";
        assert!(!ymd_hms_matcher(time_str));
    }
    ...
    /// expected: `false`
    #[test]
    fn test_ymd_hms_matcher_partial_string() {
